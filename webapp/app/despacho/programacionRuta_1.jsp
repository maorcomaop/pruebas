                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding-smin active">
                        ...
                        <div class="row">
                            <div class="control-group">   
                                ...
                                <div class="col-sm-3" style="margin-top: 3px;">                                    
                                    ...
                                    <button onclick="dph_eliminarProgramacionRuta();"  style="margin-left: 6px;">Eliminar</button>
                        ...
                        <div style="padding-top: 16px;">                    
                            ...
                            <button onclick="dph_programarRuta();" style="width: 96px; margin-left: 6px;">Guardar</button>                
