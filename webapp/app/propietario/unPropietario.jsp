            ...
            <div class="control-group">
                 ...
                 <div class="controls">
                    <select class="selectpicker " data-style="btn-primary" name="tipo_doc_edit" id="type">
                      ...
                      <c:forEach items="${select.lsttipodocumento}" var="typeDoc">
...
<script>   
     $( document ).ready(function() {
         $("#compa option[value="+ ${conductor.codEmpresa}  +"]").attr("selected",true);
         $("#type option[value="+ ${conductor.id_tipo_documento}  +"]").attr("selected",true);
