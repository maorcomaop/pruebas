        ...
        <c:choose>
            <c:when test="${permissions.check(['Configuracion','Vehiculos','GruposMoviles','RegistrarGruposMoviles'])}">
                <ul class="nav nav-tabs">
                    <li role="presentation" class="active"><a href="/RDW1/app/propietario/nuevoPropietario.jsp">Registro</a></li>                    
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">         
                        <form class="form-horizontal" action="<c:url value='/guardarPropietarioVehiculos' />" method="post">
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        <div class="controls">
                                            <select class="selectpicker" data-actions-box="true" title="Seleccione un propietario" data-style="btn-primary" name="propietario" id="owner">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="control-group">                                  
                                ...
                                <div class="controls">
                                    <select class="selectpicker" multiple data-actions-box="true" title="Seleccione un vehiculo" data-style="btn-primary" name="vehiculo" id="car">
                                    </select>
                                </div>
                            </div>
                            <br>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.post("/RDW1/consultarPerfilPropietario", {perfil:'Propietario'},
         ...
         $.post("/RDW1/consultarVehiculos", {id:1}, function (result) { $("#car").append(result); $("#car").selectpicker("refresh");});
