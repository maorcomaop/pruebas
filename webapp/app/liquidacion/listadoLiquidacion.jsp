        ...
        <c:choose>
            <c:when test="${permissions.check(81)}">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="/RDW1/app/liquidacion/listadoLiquidacion.jsp">Listado Liquidaciones</a></li>                    
                </ul>
                                    ...
                                    <tbody>                            
                                        <tr>
                                            <c:forEach items="${datos}" var="liquidacion">    
                                                ...
                                                <td>${emp.simboloMoneda} ${liquidacion.valorTarifa}</td>
                                                <td><fmt:formatNumber type = "number" maxIntegerDigits = "4" value = "${liquidacion.totalPasajerosLiquidados}" /></td>                                        
                                                <td>${emp.simboloMoneda} <fmt:formatNumber type = "number" maxIntegerDigits = "10" value = "${liquidacion.totalValorVueltas}" /></td>                                        
                                                <td>${emp.simboloMoneda} <fmt:formatNumber type = "number" maxIntegerDigits = "10" value = "${liquidacion.totalValorDescuentos}" /></td>
                                                <td>${emp.simboloMoneda} <fmt:formatNumber type = "number" maxIntegerDigits = "10" value = "${liquidacion.subTotal}" /></td>
                                                <td>${emp.simboloMoneda} <fmt:formatNumber type = "number" maxIntegerDigits = "10" value = "${liquidacion.totalValorOtrosDescuentos}" /></td>                                        
                                                <td>${emp.simboloMoneda} <fmt:formatNumber type = "number" maxIntegerDigits = "10" value = "${liquidacion.totalLiquidacion}" /></td>
