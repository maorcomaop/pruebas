<%-- 
    Document   : verConfiguracionLiquidacion
    Created on : 01-oct-2018, 14:50:43
...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(233)}">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active">
                        <a href="/RDW1/app/mantenimiento/listadoTipoEventoMantenimiento.jsp">Editar Configuración: ${configuracionLiquidacion.nombreConfiguracionLiquidacion}</a>
                    </li>
                </ul>
                <c:choose>      
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal formulario" action="<c:url value='/editarConfiguracionLiquidacion' />" method="post">
                            <div class="control-group">
                                <div class="control-group">                                        
                                    <div class="controls">
                                        <input type="hidden" name="id_edit" value="${configuracionLiquidacion.id}">
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <input type="text" name="nombreConfiguracionLiquidacion" id="nombreConfiguracionLiquidacion" 
                                                   ...
                                                   value="${configuracionLiquidacion.nombreConfiguracionLiquidacion}">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqPasajeros1" id="etqPasajeros1" 
                                                   ...
                                                   maxlength="40"
                                                   value="${configuracionLiquidacion.etqPasajeros1}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqPasajeros2" id="etqPasajeros2" 
                                                   ...
                                                   maxlength="40"
                                                   value="${configuracionLiquidacion.etqPasajeros2}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqPasajeros3" id="etqPasajeros3" 
                                                   ...
                                                   maxlength="40"
                                                   value="${configuracionLiquidacion.etqPasajeros3}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqPasajeros4" id="etqPasajeros4" 
                                                   ...
                                                   maxlength="40"
                                                   value="${configuracionLiquidacion.etqPasajeros4}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqPasajeros5" id="etqPasajeros5" 
                                                   ...
                                                   maxlength="40"
                                                   value="${configuracionLiquidacion.etqPasajeros5}">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal1" id="etqTotal1" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal1}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal2" id="etqTotal2" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal2}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal3" id="etqTotal3" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal3}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal4" id="etqTotal4" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal4}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal5" id="etqTotal5" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal5}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal6" id="etqTotal6" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal6}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal7" id="etqTotal7" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal7}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqTotal8" id="etqTotal8" 
                                               ...
                                               maxlength="40"
                                                   value="${configuracionLiquidacion.etqTotal8}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqRepPasajeros1" id="etqRepPasajeros1" 
                                                   ...
                                                   title="Ingrese un valor para ETQ_PASAJEROS 1." 
                                                   maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepPasajeros1}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqRepPasajeros2" id="etqRepPasajeros2" 
                                                   ...
                                                   title="Ingrese un valor para ETQ_PASAJEROS 2." 
                                                   maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepPasajeros2}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqRepPasajeros3" id="etqRepPasajeros3" 
                                                   ...
                                                   title="Ingrese un valor para ETQ_PASAJEROS 3." 
                                                   maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepPasajeros3}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqRepPasajeros4" id="etqRepPasajeros4" 
                                                   ...
                                                   title="Ingrese un valor para ETQ_PASAJEROS 4." 
                                                   maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepPasajeros4}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="etqRepPasajeros5" id="etqRepPasajeros5" 
                                                   ...
                                                   title="Ingrese un valor para ETQ_PASAJEROS 5." 
                                                   maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepPasajeros5}">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal1" id="etqRepTotal1" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 1." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal1}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal2" id="etqRepTotal2" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 2." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal2}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal3" id="etqRepTotal3" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 3." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal3}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal4" id="etqRepTotal4" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 4." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal4}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal5" id="etqRepTotal5" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 5." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal5}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal6" id="etqRepTotal6" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 6." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal6}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal7" id="etqRepTotal7" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 7." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal7}">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="etqRepTotal8" id="etqRepTotal8" 
                                               ...
                                               title="Ingrese un valor para ETQ_TOTAL 8." 
                                               maxlength="40" required
                                                   value="${configuracionLiquidacion.etqRepTotal8}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="radio" name="modoLiquidacion" id="liquidacionNormal" value="1" 
                                                   <c:if test="${configuracionLiquidacion.liquidacionNormal}">checked="checked"</c:if>>
                                            ...
                                            <input type="radio" name="modoLiquidacion" id="liquidacionPorRuta" value="2" 
                                                   <c:if test="${configuracionLiquidacion.liquidacionPorRuta}">checked="checked"</c:if>> 
                                            ...
                                            <input type="radio" name="modoLiquidacion" id="liquidacionPorTramo" value="3" 
                                                   <c:if test="${configuracionLiquidacion.liquidacionPorTramo}">checked="checked"</c:if>> 
                                            ...
                                            <input type="radio" name="modoLiquidacion" id="liquidacionPorTiempo" value="4" 
                                                   <c:if test="${configuracionLiquidacion.liquidacionPorTiempo}">checked="checked"</c:if>>
                                            ...
                                            <input type="radio" name="modoLiquidacion" id="liquidacionSoloPasajeros" value="5" 
                                                   <c:if test="${configuracionLiquidacion.liquidacionSoloPasajeros}">checked="checked"</c:if>> 
                                            ...
                                            <div class="col-sm-4">
                                                <select class="selectpicker form-control" data-style="btn-primary" name="perfil" 
                                                    ...
                                                    <c:if test="${permissions.check(-1)}">
                                                        <option value="1" <c:if test="${1 eq configuracionLiquidacion.fkPerfil}">selected</c:if>>
                                                            Super Usuario</option>
                                                    </c:if>
                                                <c:forEach items="${select.lstperfil}" var="perfil">
                                                    <c:if test="${perfil.estado eq 1}">
                                                        <option value="${perfil.id}" 
                                                                <c:if test="${perfil.id eq configuracionLiquidacion.fkPerfil}">selected</c:if>>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="radio" name="estado" id="activo" value="1"
                                               <c:if test="${configuracionLiquidacion.estado eq 1}">checked="checked"</c:if>>
                                        ...
                                        <input type="radio" name="estado" id="inactivo" value="0"
                                               <c:if test="${configuracionLiquidacion.estado eq 0}">checked="checked"</c:if>> 
