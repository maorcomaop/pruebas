<%-- 
    Document   : verTipoEventoMantenimiento
    Created on : 17-jul-2018, 15:07:47
            ...
            <c:when test="${permissions.check(198)}">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active">
                        <a href="/RDW1/app/mantenimiento/listadoTipoEventoMantenimiento.jsp">Tipo Evento: ${tipoEventoMantenimiento.nombre}</a>
                    </li>
                </ul>
                <c:choose>      
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/editarTipoEventoMantenimiento' />" method="post">
                            <div class="control-group">
                                <div class="control-group">                                        
                                    <div class="controls">
                                        <input type="hidden" name="id_edit" value="${tipoEventoMantenimiento.id}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="nombre" id="nombre" required
                                               ...
                                               maxlength="250" value="${tipoEventoMantenimiento.nombre}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="unidadMedida" id="unidadMedida" required
                                               ...
                                               maxlength="50"  value="${tipoEventoMantenimiento.unidadMedida}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <textarea name="descripcion" id="descripcion" 
                                               ...
                                               style="resize: none;" rows="5" maxlength="2000"><c:out value="${tipoEventoMantenimiento.descripcion}" /></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="myDiv"></div>
