<%-- 
    Document   : verMantenimiento
    Created on : 18-jul-2018, 8:56:25
...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(204)}">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation"  class="active">
                        <a href="/RDW1/app/mantenimiento/listadoTipoEventoMantenimiento.jsp">Editar Mantenimiento</a>
                    </li>
                </ul>
                <c:choose>      
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal formulario" action="<c:url value='/editarMantenimiento' />" method="post">
                            <div class="control-group">
                                <div class="control-group">                                        
                                    <div class="controls">
                                        <input type="hidden" name="id_edit" value="${mantenimiento.id}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="nombre" id="nombre" 
                                               ...
                                               maxlength="250" value="${mantenimiento.nombre}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                        ...
                                        <select class="selectpicker " data-style="btn-primary" name="tipoEventoMantenimiento" 
                                            ...
                                            <c:forEach items="${select.lst_tipoEventoMantenimiento}" var="tipoEventoMantenimiento">
                                                <c:if test="${tipoEventoMantenimiento.estado eq 1}">
                                                    <option value="${tipoEventoMantenimiento.id}"
                                                            <c:if test="${tipoEventoMantenimiento.id eq mantenimiento.fkTipoEventoMantenimiento}">selected</c:if>>
                                                        ${tipoEventoMantenimiento.nombre}</option>
                                                </c:if>
                                            </c:forEach>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="date" name="fechaActivacion" id="fechaActivacion" 
                                               ...
                                               required
                                               value="${mantenimiento.fechaActivacionNotificacionString}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="number" name="unidades" id="unidades" required
                                               ...
                                               max="9999999" 
                                               value="${mantenimiento.valorPrimeraNotificacion}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="radio" name="repeticion" id="estatico"
                                               ...
                                               value="0" 
                                               <c:if test="${mantenimiento.repetirNotificacion eq 0}">checked="checked"</c:if>>
                                        <label for="estatico">Una Vez</label>
                                        <input type="radio" name="repeticion" id="ciclico"
                                               data-toggle="tooltip" 
                                               title="Seleccione si el evento es estático o se repetirá indefinidamente."
                                               value="1" <c:if test="${mantenimiento.repetirNotificacion eq 1}">checked="checked"</c:if>> 
                            ...
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="intervalo" class="control-label" id="lblUnidadMedida">Intervalo Repetición (Minutos) *</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="number" name="intervalo" id="intervalo" required
                                               ...
                                               min="1" max="525600" 
                                               value="${mantenimiento.intervaloRepeticion}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="cantidadNotificaciones" class="control-label" id="lblUnidadMedida">Cantidad Repeticiones Notificación *</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="number" name="cantidadNotificaciones" id="cantidadNotificaciones" required
                                               ...
                                               min="1" max="10" 
                                               value="${mantenimiento.cantidadNotificaciones}" >
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="radio" name="activarMantenimiento" id="activar"
                                               ...
                                               value="1" 
                                               <c:if test="${mantenimiento.notificacionActiva eq 1}">checked="checked"</c:if>>
                                               <label for="activar">Activar</label>
                                               <input type="radio" name="activarMantenimiento" id="noActivar"
                                                      data-toggle="tooltip" 
                                                      title="Seleccione si el mantenimiento se activa inmediatamente después de guardado."
                                                      value="0"
                                               <c:if test="${mantenimiento.notificacionActiva eq 0}">checked="checked"</c:if>> 
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <textarea name="correos" id="correos" 
                                               ...
                                               style="resize: none;" rows="5" maxlength="2000"><c:out value="${mantenimiento.correosNotificacion}" /></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <textarea name="observaciones" id="observaciones" 
                                               ...
                                               style="resize: none;" rows="5" maxlength="2000"><c:out value="${mantenimiento.observacionesNotificacion}" /></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
