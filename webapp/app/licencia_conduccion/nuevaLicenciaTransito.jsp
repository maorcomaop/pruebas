<%-- 
    Document   : nuevaLicenciaTransito
    Created on : 12-jul-2018, 8:36:17
...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(180)}">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/guardarLicenciaTransito' />" method="post">
                                        ...
                                        <select class="selectpicker " data-style="btn-primary" name="conductor" id="conductor" required>
                                            ...
                                            <c:forEach items="${select.lstconductor}" var="conductor">
                                                <c:if test="${conductor.estado eq 1}">
                                                    <option value="${conductor.id}">${conductor.nombre} ${conductor.apellido} - ${conductor.cedula}</option>
                                                </c:if>
                                            </c:forEach>
                                        </select>
                                    </div>
