<%-- 
    Document   : nuevaOficinaTransito
    Created on : 11-jul-2018, 12:03:32
...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(176)}">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/guardarOficinaTransito' />" method="post">
