...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(174)}">.
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active">
                        <a href="/RDW1/app/licencia_conduccion/listadoCategoriaLicencia.jsp">Categoría Licencia: ${categoriaLicencia.nombre}</a>
                    </li>
                </ul>
                <c:choose>      
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/editarCategoriaLicencia' />" method="post">
                            <div class="control-group">
                                <div class="control-group">                                        
                                    <div class="controls">
                                        <input type="hidden" name="id_edit" value="${categoriaLicencia.id}">
                                    </div>
                                </div>
                            </div>    
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="nombre" id="nombre" required
                                               class="form-control" data-toggle="tooltip" title="Dígite el nombre de la categoría."
                                               value="${categoriaLicencia.nombre}" maxlength="250">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <textarea name="descripcion" id="descripcion" 
                                               class="form-control" data-toggle="tooltip" title="Dígite la descripción de la categoría."
                                               style="resize: none;" rows="5" maxlength="1000"
                                               ><c:out value="${categoriaLicencia.descripcion}" /></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
