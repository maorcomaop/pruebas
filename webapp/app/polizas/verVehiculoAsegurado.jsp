<%-- 
    Document   : editarVehiculoAsegurado
    Created on : 16-jul-2018, 10:55:02
...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(195)}">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active">
                        <a href="/RDW1/app/polizas/listadoVehiculoAsegurado.jsp">Vehículo Asegurado: ${vehiculoAsegurado.placaVehiculo}</a>
                    </li>    
                </ul>
                <c:choose>      
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/editarVehiculoAsegurado' />" method="post">
                            <div class="control-group">
                                <div class="control-group">                                        
                                    <div class="controls">
                                        <input type="hidden" name="id_edit" value="${vehiculoAsegurado.id}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                        ...
                                        <select class="selectpicker " data-style="btn-primary" name="poliza" id="poliza" required>
                                            ...
                                            <c:forEach items="${select.lst_polizas}" var="poliza">
                                                <c:if test="${poliza.estado eq 1}">
                                                    <option value="${poliza.id}" <c:if test="${poliza.id eq vehiculoAsegurado.fkPoliza}">selected</c:if>>
                                                        ${poliza.nombre}</option>
                                                </c:if>
                                            </c:forEach>
                                        </select>
                                    </div>
                                        ...
                                        <select class="selectpicker " data-style="btn-primary" name="vehiculo" id="vehiculo" required>
                                            ...
                                            <c:forEach items="${select.lstmovil}" var="vehiculo">
                                                <c:if test="${vehiculo.estado eq 1}">
                                                    <option value="${vehiculo.id}" <c:if test="${vehiculo.id eq vehiculoAsegurado.fkVehiculo}">selected</c:if>>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="numeroPoliza" id="numeroPoliza" required
                                               ...
                                               maxlength="50" value="${vehiculoAsegurado.numeroPoliza}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="date" name="inicioVigencia" id="inicioVigencia" 
                                               ...
                                               required value="${vehiculoAsegurado.inicioVigenciaBack}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="date" name="finVigencia" id="finVigencia" 
                                               ...
                                               required value="${vehiculoAsegurado.finVigenciaBack}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="number" name="valorPrima" id="valorPrima" required
                                               ...
                                               maxlength="20" min="1" value="${vehiculoAsegurado.valorPrima}">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
