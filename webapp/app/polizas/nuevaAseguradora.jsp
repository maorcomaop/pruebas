<%-- 
    Document   : nuevaAseguradora
    Created on : 13-jul-2018, 10:36:57
...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(185)}">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/guardarAseguradora' />" method="post">
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="nombre" class="control-label">Nombre Aseguradora *</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="nombre" id="nombre" required
                                               ...
                                               title="Dígite el nombre de la aseguradora."
                                               maxlength="50">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="telefono" class="control-label">Teléfono Aseguradora</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="telefono" id="telefono"
                                               class="form-control" data-toggle="tooltip" 
                                               title="Dígite el teléfono de la aseguradora."
                                               maxlength="50">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="paginaWeb" class="control-label">Página Web Aseguradora</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" name="paginaWeb" id="paginaWeb"
                                               class="form-control" data-toggle="tooltip" 
                                               title="Dígite la dirección de la página web de la aseguradora."
                                               maxlength="250">
                                    </div>
                                </div>
                            </div>
