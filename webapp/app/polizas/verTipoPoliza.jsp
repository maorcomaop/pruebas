<%-- 
    Document   : verTipoPoliza
    Created on : 31-jul-2018, 15:33:05
        ...
        <c:choose>
            <c:when test="${permissions.check(207)}">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active">
                        <a href="#">Tipo Póliza: ${tipoPoliza.nombre}</a> 
                    </li>
                </ul>
                <c:choose>      
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/editarTipoPoliza' />" method="post">
                            <div class="control-group">
                                <div class="control-group">                                        
                                    <div class="controls">
                                        <input type="hidden" name="id_edit" value="${tipoPoliza.id}">
                                    </div>
                                </div>
                            </div> 
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <textarea name="descripcion" id="descripcion" 
                                               ...
                                               rows="5" maxlength="2000"><c:out value="${tipoPoliza.descripcion}"></c:out></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
