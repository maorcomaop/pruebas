<%-- 
    ...
    Created on : 13-jul-2018, 15:30:45
...
<div class="col-lg-12 centered">
    ...
    <section class="boxed padding">
        <c:choose>
            <c:when test="${permissions.check(189)}">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/guardarPoliza' />" method="post">
                                        ...
                                        <select class="selectpicker " data-style="btn-primary" name="tipoPoliza" 
                                            ...
                                            <c:forEach items="${select.lst_tipoPoliza}" var="tipoPoliza">
                                                <c:if test="${tipoPoliza.estado eq 1}">
                                                    <option value="${tipoPoliza.id}">${tipoPoliza.nombre}</option>
                                                </c:if>
                                            </c:forEach>
                                        </select>
                                    </div>
