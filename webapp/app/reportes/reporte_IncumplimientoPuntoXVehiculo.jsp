        ...
        <div class="tab-content">
            ...
            <div class="padding-smin">
                <div class="row">
                    <div class="control-group">
                        <label class="col-sm-8"><h4>Incumplimiento de puntos control por veh&iacute;culo(s)</h4></label>
                    </div>
                </div>
                <div class="row">
                    <div class="control-group">
            ...
            <table id="tablaIncumplimientoPunto" class="display td-center" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <c:forEach items="${lst_pnrxv}" var="pnr">
                        <tr>
                            <td>${pnr.fecha}</td>                            
                            <td>
                                <form target="_blank" action="<c:url value='/reporteIncumplimientoPuntoXConductor' />" method="post">
                                    ...
                                    <input type="hidden" id="idVehiculo" name="idVehiculo" value="${pnr.idVehiculo}">
                                    <input type="hidden" id="placa" name="placa" value="${pnr.placa}">
                                    <input type="hidden" id="numeroInterno" name="numeroInterno" value="${pnr.numeroInterno}">
                                    <input type="hidden" id="fecha" name="fecha" value="${pnr.fecha}">
                                    <button class="button2link">${pnr.placa} - ${pnr.numeroInterno}</button>
                                </form>
                            </td>
                            <c:choose>
