        ...
        <c:choose>
            <c:when test="${permissions.check(66)}">
                <ul class="nav nav-tabs">
                    <li role="presentation" class="active"><a href="/RDW1/app/tarjetaDeOperacion/nuevoTarjetaOperacion.jsp">Registro</a></li>                        
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane padding active" id="pestana1">
                        ...
                        <form class="form-horizontal" action="<c:url value='/guardarTarjetaOperacion' />" method="post">
                            ...
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">                                    
                                        <select class="selectpicker " data-style="btn-primary" name="fk_ce" id="fk_cx" title="Seleccione">                                                                                        
                                        </select>
                                    </div>
                                </div>
                            </div>                            
                            ...
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">   
                                        <input type="text" name="mod" id="mo"  class="form-control" data-toggle="tooltip" title="Digite" autofocus>
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="control-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">                                                                            
                                        <textarea cols="10" rows="5" name="obs" id="ob" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div> 
                            <br>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <input type="submit" class="btn btn-primary botonSoat" data-toggle="tooltip" title="Haga clic aqui para guardar" value="Guardar">
                                </div>
                            </div>    
                        </form>
                    </div>
