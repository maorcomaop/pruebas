    ...
    <footer>
        ...
        <!--
        <script src="/RDW1/resources/extern/right/right.js"></script>
        <script src="/RDW1/resources/extern/right/right-calendar.js"></script>        
        <script src="http://code.jquery.com/jquery.js"></script>
        -->
        <script src="/RDW1/resources/extern/bootstrap-files/js/jquery-2.2.4.js"></script>
        <script src="/RDW1/resources/extern/jquery-ui/jquery-ui.js"></script>
        <!-- <script src="/RDW1/resources/extern/bootstrap-files/js/bootstrap.js"></script> -->
        ...
        <script src="/RDW1/resources/extern/bootstrap-files/js/bootstrap-datepicker.js"></script> 
        ...
        <!-- <script type="text/javascript" src="/RDW1/resources/extern/leaflet-label/leaflet-src.js"></script> -->
        
        <script type="text/javascript" src="/RDW1/resources/js/map.ruta.js"></script>
        <script type="text/javascript" src="/RDW1/resources/js/util.js"></script>
        <script type="text/javascript" src="/RDW1/resources/js/util2.js"></script>
        <script type="text/javascript" src="/RDW1/resources/js/util_dph.js"></script>
        <script type="text/javascript" src="/RDW1/resources/js/multipleSelect.js"></script>
